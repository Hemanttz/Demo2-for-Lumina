  ...
  return (
    <section id="home" className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        />
        {/* Light overlay for premium beige/gold aesthetic */}
        <div className="absolute inset-0 bg-stone-50/30 mix-blend-overlay"></div>
        <div className="absolute inset-0 bg-white/10"></div>
      </div>

      {/* Content */}
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
        <h2 className="font-serif italic text-2xl md:text-3xl text-stone-800 mb-6 drop-shadow-sm opacity-0 animate-fade-in-up">
